...
public class TestEnv extends Environment {
    ...
    Location lcaja = new Location(pos_x_caja, pos_y_caja); //Location de la caja
    ...
    Location lcaja_delante = new Location(pos_x_caja_delante, pos_y_caja_delante); //Location de la caja
    ...
    Location lcajon = new Location(pos_x_cajon, pos_y_cajon);
    ...
    */
    ...
    class MarsModel extends GridWorldModel{
        ...
        void tomar_libro(int x,int y, String tipo_objeto,InfoLibro info)
        {
            /*
        ...
        void colocarlibro(int x, int y, String tipo_objeto, InfoLibro Libro)
        {
            ...
            if(tipo_objeto.equals("cajon_dev"))
            {
                ...
                logger.info("El estado del cajon de devoluciones es el siguiente : ");
                for(int i=0;i<libros_cajon.length;i++)
                {
                    logger.info("autor numero "+Integer.toString(i)+" registrado : "+libros_cajon[i].autor);
                    logger.info("autor titulo "+Integer.toString(i)+" registrado : "+libros_cajon[i].titulo);
                }
            }
